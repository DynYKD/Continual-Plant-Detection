...
#First step
python -m torch.distributed.launch --nproc_per_node=${GPU} tools/train_first_step.py -c configs/OD_cfg/OPPD/36-10/e2e_faster_rcnn_R_50_C4_1x.yaml
python tools/trim_detectron_model.py --name "36-10/LR005_BS4_50K"
